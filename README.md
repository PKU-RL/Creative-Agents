...
|Build according to an image showing a modern house with quartz_block and white_concrete|Build according to an image showing a fantastic house with quartz_block and sandstone near a river|
|:-------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------:|
